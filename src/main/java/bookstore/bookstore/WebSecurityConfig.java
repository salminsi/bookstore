    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(
                authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/books**").permitAll() // tähän urliin pääsee kirjautumatta
                                                                                 // kaikki ja lukuoikeus (myös
                                                                                 // rest-rajapinta) sallittu kaikille
                        .requestMatchers(HttpMethod.POST, "/books**").permitAll() // kaikilla post-oikeus
                        .requestMatchers(HttpMethod.PUT, "/books**").permitAll() // kaikilla put-oikeus
                        .requestMatchers(HttpMethod.DELETE, "/books**").hasAuthority("ADMIN") // vain admin pystyy
                                                                                              // deletoimaan. Pitää olla
                                                                                              // Authority, ei Role.
                        .requestMatchers("/h2-console/**").permitAll() // for h2console, vaihdettu suora url niin toimii
                ...
                .httpBasic(Customizer.withDefaults()) // tämän avulla voi tehdä Postmanin kautta kirjautumisen, jotta
